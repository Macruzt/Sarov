        ...
        <table cellpadding="0" cellspacing="0">
            <tr class="top_rw">
                <td colspan="2">
                    ...
                    <h2 style="text-align: left;">ACTA DE ENTREGA</h2>
                ...
                <td style="width:50%; text-align: right; vertical-align: top;">
                    <div style="clear: both; text-align: right; margin-right: 10px;">
                        Encuesta de satisfacción</b>
                    </div>
                    <img src="{{ base_path('/public/vendor/crudbooster/assets/QR_encuesta.png')}}" alt="QR encuesta " style="display: block; margin-bottom: 5px; margin-top: 10px; width: 90px; height: auto; float: right; margin-right: 10px;">
                    <div style="clear: both; text-align: right; margin-right: 10px;">
